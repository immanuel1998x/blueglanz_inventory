#tag Window
Begin Window WindowProduct_RentalReport
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub FetchTransactionSales()
		  ...
		  p.Value("transaction_type")  = "Rental"
		  api.SetFormData(p)              
