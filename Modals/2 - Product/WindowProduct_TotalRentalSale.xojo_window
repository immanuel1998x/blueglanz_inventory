#tag Window
Begin Window WindowProduct_TotalRentalSale
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub FetchTransactionSalesRentals()
		  ...
		  If responseData.Value("status") = 200 Then
		    PopulateListBoxTransactionSalesRentals(responseData)
	...
	#tag Method, Flags = &h0
		Sub PopulateListBoxTransactionSalesRentals(responsedata as JSONItem)
...
#tag Events ListBoxSales
	#tag Event
		Sub Open()
		  Self.FetchTransactionSalesRentals
		  Self.Label1.Value = Me.RowCount.ToString
		  Me.SetDefaultProperties
...
#tag Events ButtonCancel1
	#tag Event
		Sub LeftClick()
		  ...
		  pdf.Generate_RentalsSales_ModalPDF
		End Sub
	#tag EndEvent
	#tag Event
		Sub Open()
