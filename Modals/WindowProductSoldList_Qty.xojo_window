#tag Window
Begin Window WindowProductSoldList_Qty
   Backdrop        =   0
   ...
   Begin CustomCanvas_Background CustomCanvas_Background1
      ...
      Begin Label Label1
         ...
         Width           =   80
      End
      Begin TextField1 CProductTypeTextField
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub insertNewProductType()
		  ...
		  Var response As New JSONItem(api.Post(App.URL + "/product_category/insert", 2))
		  ...
		  'WindowProduct.fetchResponseProductTypes
...
#tag Events ButtonSave
	...
	#tag Event
		Sub LeftClick()
		  product_stock = CProductTypeTextField.Value
		  Var POSVI As New POSViewIndex
		  POSVI.Populate_Order_PassData
